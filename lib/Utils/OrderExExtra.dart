...
extension OrderExe on ClientOrderDetails{
  String getStoreName(){
    ...
    return isSingleProvider() ? orderItems.isNotEmpty ? orderItems.first.name ?? "" : "" : "More stores" ;
  }
  ...
  String? getStoreImage(){
    ...
    return isSingleProvider() ? orderItems.isNotEmpty ? orderItems.first.imagePath : "" : null ;
  }
