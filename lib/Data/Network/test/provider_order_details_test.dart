...
// tests for ProviderOrderDetails
void main() {
  // final instance = ProviderOrderDetails();

  group('test ProviderOrderDetails', () {
    ...
    // List<ProviderOrderDetailsOrderItemsInner> orderItems (default value: const [])
    ...
    test('to test the property `giftBox`', () async {
      // TODO
    });

    // ProviderOrderDetailsGiftBox giftCard
    test('to test the property `giftCard`', () async {
      // TODO
    });
