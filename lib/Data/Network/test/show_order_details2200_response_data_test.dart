...
// tests for ShowOrderDetails2200ResponseData
void main() {
  // final instance = ShowOrderDetails2200ResponseData();

  group('test ShowOrderDetails2200ResponseData', () {
    ...
    // List<ShowOrderDetails2200ResponseDataOrderItemsInner> orderItems (default value: const [])
