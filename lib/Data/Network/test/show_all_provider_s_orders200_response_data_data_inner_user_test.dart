...
// tests for ShowAllProviderSOrders200ResponseDataDataInnerUser
void main() {
  // final instance = ShowAllProviderSOrders200ResponseDataDataInnerUser();

  group('test ShowAllProviderSOrders200ResponseDataDataInnerUser', () {
    // String balance
