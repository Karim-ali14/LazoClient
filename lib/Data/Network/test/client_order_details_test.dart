...
// tests for ClientOrderDetails
void main() {
  // final instance = ClientOrderDetails();

  group('test ClientOrderDetails', () {
    ...
    // List<ClientOrderDetailsOrderItemsInner> orderItems (default value: const [])
