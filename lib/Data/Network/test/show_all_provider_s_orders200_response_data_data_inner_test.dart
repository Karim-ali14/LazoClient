...
// tests for ShowAllProviderSOrders200ResponseDataDataInner
void main() {
  // final instance = ShowAllProviderSOrders200ResponseDataDataInner();

  group('test ShowAllProviderSOrders200ResponseDataDataInner', () {
    ...
    // String orderFamily
    test('to test the property `orderFamily`', () async {
      // TODO
    });

    // List<ShowAllProviderSOrders200ResponseDataDataInnerOrderItemsInner> orderItems (default value: const [])
    test('to test the property `orderItems`', () async {
      // TODO
    });

    // Object packagingProviderId
    test('to test the property `packagingProviderId`', () async {
      // TODO
    });
    ...
    test('to test the property `promocodeDiscountType`', () async {
      // TODO
    });

    // num promocodeDiscountValue
    test('to test the property `promocodeDiscountValue`', () async {
      // TODO
    });

    // num promocodeId
    test('to test the property `promocodeId`', () async {
      // TODO
    });
    ...
    test('to test the property `ratingComment`', () async {
      // TODO
    });

    // String receiverAddress
    test('to test the property `receiverAddress`', () async {
      // TODO
    });

    // String receiverPhoneNumber
    test('to test the property `receiverPhoneNumber`', () async {
      // TODO
    });
    ...
    test('to test the property `totalWithShippingFee`', () async {
      // TODO
    });
