...
part 'model/client_login200_response.dart';
part 'model/client_login200_response_data.dart';
part 'model/client_signup200_response.dart';
part 'model/client_signup200_response_data.dart';
part 'model/client_signup200_response_data_user.dart';
part 'model/client_signup200_response_data_user_city.dart';
...
part 'model/manage_orders1200_response.dart';
part 'model/manage_orders1200_response_data.dart';
part 'model/manage_orders1200_response_data_order_items_inner.dart';
part 'model/manage_orders1200_response_data_order_items_inner_product.dart';
part 'model/manage_orders1200_response_data_order_items_inner_product_lists_inner.dart';
part 'model/manage_orders1200_response_data_order_items_inner_product_lists_inner_items_inner.dart';
...
part 'model/show_all_provider_s_orders200_response_data_data_inner.dart';
part 'model/show_all_provider_s_orders200_response_data_data_inner_order_items_inner.dart';
part 'model/show_all_provider_s_orders200_response_data_data_inner_order_items_inner_service.dart';
part 'model/show_all_provider_s_orders200_response_data_data_inner_order_items_inner_service_lists_inner.dart';
part 'model/show_all_provider_s_orders200_response_data_data_inner_order_items_inner_service_lists_inner_items_inner.dart';
part 'model/show_all_provider_s_orders200_response_data_data_inner_promocode.dart';
part 'model/show_all_provider_s_orders200_response_data_data_inner_user.dart';
part 'model/show_all_services_with_filter200_response.dart';
part 'model/show_all_services_with_filter200_response_data.dart';
part 'model/show_all_services_with_filter200_response_data_data_inner.dart';
part 'model/show_all_services_with_filter200_response_data_links_inner.dart';
...
part 'model/show_home200_response_data_categories_inner.dart';
part 'model/show_home200_response_data_occasions_inner.dart';
part 'model/show_home200_response_data_top_rated_products_inner.dart';
part 'model/show_home200_response_data_top_rated_providers_inner.dart';
part 'model/show_home200_response_data_top_rated_services_inner.dart';
...
part 'model/show_order_details2200_response_data_order_items_inner_product.dart';
part 'model/show_order_details2200_response_data_order_items_inner_product_lists_inner.dart';
part 'model/show_order_details2200_response_data_order_items_inner_product_lists_inner_items_inner.dart';
...
part 'model/show_wishlist_items_with_search_by_name200_response_data_inner.dart';
part 'model/show_wishlist_items_with_search_by_name200_response_data_inner_items_inner.dart';
