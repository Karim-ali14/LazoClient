...
class ProviderOrderDetailsOrderItemsInnerService {
  /// Returns a new [ProviderOrderDetailsOrderItemsInnerService] instance.
  ...
  List<ProviderOrderDetailsOrderItemsInnerServiceListsInner> lists;
  ...
  /// Returns a new [ProviderOrderDetailsOrderItemsInnerService] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ProviderOrderDetailsOrderItemsInnerService? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ProviderOrderDetailsOrderItemsInnerService[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ProviderOrderDetailsOrderItemsInnerService[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ProviderOrderDetailsOrderItemsInnerService> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ProviderOrderDetailsOrderItemsInnerService>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ProviderOrderDetailsOrderItemsInnerService.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ProviderOrderDetailsOrderItemsInnerService> mapFromJson(dynamic json) {
    final map = <String, ProviderOrderDetailsOrderItemsInnerService>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ProviderOrderDetailsOrderItemsInnerService.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ProviderOrderDetailsOrderItemsInnerService-objects as value to a dart map
  static Map<String, List<ProviderOrderDetailsOrderItemsInnerService>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ProviderOrderDetailsOrderItemsInnerService>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ProviderOrderDetailsOrderItemsInnerService.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
