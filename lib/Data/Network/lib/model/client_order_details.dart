...
class ClientOrderDetails {
  ...
  bool operator ==(Object other) => identical(this, other) || other is ClientOrderDetails &&
    ...
    other.totalDeliveryPrice == totalDeliveryPrice &&
    other.type == type &&
  ...
  int get hashCode =>
    ...
    (totalDeliveryPrice == null ? 0 : totalDeliveryPrice!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.totalDeliveryPrice != null) {
      json[r'total_delivery_price'] = this.totalDeliveryPrice;
    } else {
      json[r'total_delivery_price'] = null;
    }
    if (this.type != null) {
  ...
  /// Returns a new [ClientOrderDetails] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ClientOrderDetails? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ClientOrderDetails[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ClientOrderDetails[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ClientOrderDetails> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ClientOrderDetails>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ClientOrderDetails.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ClientOrderDetails> mapFromJson(dynamic json) {
    final map = <String, ClientOrderDetails>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ClientOrderDetails.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ClientOrderDetails-objects as value to a dart map
  static Map<String, List<ClientOrderDetails>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ClientOrderDetails>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ClientOrderDetails.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
