...
class ProviderOrderDetailsOrderItemsInnerProduct {
  /// Returns a new [ProviderOrderDetailsOrderItemsInnerProduct] instance.
  ProviderOrderDetailsOrderItemsInnerProduct({
    this.hasStock,
    this.amount,
  ...
  /// Returns a new [ProviderOrderDetailsOrderItemsInnerProduct] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ProviderOrderDetailsOrderItemsInnerProduct? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ProviderOrderDetailsOrderItemsInnerProduct[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ProviderOrderDetailsOrderItemsInnerProduct[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ProviderOrderDetailsOrderItemsInnerProduct> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ProviderOrderDetailsOrderItemsInnerProduct>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ProviderOrderDetailsOrderItemsInnerProduct.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ProviderOrderDetailsOrderItemsInnerProduct> mapFromJson(dynamic json) {
    final map = <String, ProviderOrderDetailsOrderItemsInnerProduct>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ProviderOrderDetailsOrderItemsInnerProduct.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ProviderOrderDetailsOrderItemsInnerProduct-objects as value to a dart map
  static Map<String, List<ProviderOrderDetailsOrderItemsInnerProduct>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ProviderOrderDetailsOrderItemsInnerProduct>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ProviderOrderDetailsOrderItemsInnerProduct.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
