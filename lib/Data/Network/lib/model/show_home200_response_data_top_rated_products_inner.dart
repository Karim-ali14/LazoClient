...
class ShowHome200ResponseDataTopRatedProductsInner {
  /// Returns a new [ShowHome200ResponseDataTopRatedProductsInner] instance.
  ShowHome200ResponseDataTopRatedProductsInner({
    this.amount,
    this.createdAt,
    this.description,
    this.descriptionAr,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ShowHome200ResponseDataTopRatedProductsInner &&
     other.amount == amount &&
  ...
  @override
  String toString() => 'ShowHome200ResponseDataTopRatedProductsInner[amount=$amount, createdAt=$createdAt, description=$description, descriptionAr=$descriptionAr, descriptionEn=$descriptionEn, expectedProcessingTime=$expectedProcessingTime, hasStock=$hasStock, id=$id, inCart=$inCart, inWishlist=$inWishlist, isVisible=$isVisible, name=$name, nameAr=$nameAr, nameEn=$nameEn, overallRating=$overallRating, price=$price, priceAfterDiscount=$priceAfterDiscount, providerId=$providerId, ratingsCount=$ratingsCount, type=$type, updatedAt=$updatedAt]';
  ...
  /// Returns a new [ShowHome200ResponseDataTopRatedProductsInner] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ShowHome200ResponseDataTopRatedProductsInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ShowHome200ResponseDataTopRatedProductsInner[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ShowHome200ResponseDataTopRatedProductsInner[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ShowHome200ResponseDataTopRatedProductsInner(
  ...
  static List<ShowHome200ResponseDataTopRatedProductsInner> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ShowHome200ResponseDataTopRatedProductsInner>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ShowHome200ResponseDataTopRatedProductsInner.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ShowHome200ResponseDataTopRatedProductsInner> mapFromJson(dynamic json) {
    final map = <String, ShowHome200ResponseDataTopRatedProductsInner>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ShowHome200ResponseDataTopRatedProductsInner.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ShowHome200ResponseDataTopRatedProductsInner-objects as value to a dart map
  static Map<String, List<ShowHome200ResponseDataTopRatedProductsInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ShowHome200ResponseDataTopRatedProductsInner>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ShowHome200ResponseDataTopRatedProductsInner.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
