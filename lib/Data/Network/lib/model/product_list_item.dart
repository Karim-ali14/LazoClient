...
class ProductListItem {
  ...
  List<ProductListItemDetail> items;
  ...
  /// Returns a new [ProductListItem] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ProductListItem? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ProductListItem[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ProductListItem[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ProductListItem(
        ...
        items: ProductListItemDetail.listFromJson(json[r'items']),
  ...
  static List<ProductListItem> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ProductListItem>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ProductListItem.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ProductListItem> mapFromJson(dynamic json) {
    final map = <String, ProductListItem>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ProductListItem.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ProductListItem-objects as value to a dart map
  static Map<String, List<ProductListItem>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ProductListItem>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ProductListItem.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
