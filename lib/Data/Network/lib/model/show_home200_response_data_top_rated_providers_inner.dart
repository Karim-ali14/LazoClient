...
class ShowHome200ResponseDataTopRatedProvidersInner {
  /// Returns a new [ShowHome200ResponseDataTopRatedProvidersInner] instance.
  ShowHome200ResponseDataTopRatedProvidersInner({
    this.accountType,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ShowHome200ResponseDataTopRatedProvidersInner &&
  ...
  /// Returns a new [ShowHome200ResponseDataTopRatedProvidersInner] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ShowHome200ResponseDataTopRatedProvidersInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ShowHome200ResponseDataTopRatedProvidersInner[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ShowHome200ResponseDataTopRatedProvidersInner[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ShowHome200ResponseDataTopRatedProvidersInner(
  ...
  static List<ShowHome200ResponseDataTopRatedProvidersInner> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ShowHome200ResponseDataTopRatedProvidersInner>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ShowHome200ResponseDataTopRatedProvidersInner.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ShowHome200ResponseDataTopRatedProvidersInner> mapFromJson(dynamic json) {
    final map = <String, ShowHome200ResponseDataTopRatedProvidersInner>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ShowHome200ResponseDataTopRatedProvidersInner.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ShowHome200ResponseDataTopRatedProvidersInner-objects as value to a dart map
  static Map<String, List<ShowHome200ResponseDataTopRatedProvidersInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ShowHome200ResponseDataTopRatedProvidersInner>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ShowHome200ResponseDataTopRatedProvidersInner.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
