...
class ShowAllServicesWithFilter200ResponseDataDataInner {
  /// Returns a new [ShowAllServicesWithFilter200ResponseDataDataInner] instance.
  ShowAllServicesWithFilter200ResponseDataDataInner({
    this.cardExpiration,
    this.cardPrice,
    this.cardType,
    this.coverImagePath,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ShowAllServicesWithFilter200ResponseDataDataInner &&
  ...
  @override
  String toString() => 'ShowAllServicesWithFilter200ResponseDataDataInner[cardExpiration=$cardExpiration, cardPrice=$cardPrice, cardType=$cardType, coverImagePath=$coverImagePath, coverImage=$coverImage, createdAt=$createdAt, description=$description, descriptionAr=$descriptionAr, descriptionEn=$descriptionEn, duration=$duration, id=$id, isServiceDeliverableOutsideStore=$isServiceDeliverableOutsideStore, isVisible=$isVisible, name=$name, nameAr=$nameAr, nameEn=$nameEn, price=$price, priceAfterDiscount=$priceAfterDiscount, providerId=$providerId, updatedAt=$updatedAt]';
  ...
  /// Returns a new [ShowAllServicesWithFilter200ResponseDataDataInner] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ShowAllServicesWithFilter200ResponseDataDataInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ShowAllServicesWithFilter200ResponseDataDataInner[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ShowAllServicesWithFilter200ResponseDataDataInner[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ShowAllServicesWithFilter200ResponseDataDataInner(
  ...
  static List<ShowAllServicesWithFilter200ResponseDataDataInner> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ShowAllServicesWithFilter200ResponseDataDataInner>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ShowAllServicesWithFilter200ResponseDataDataInner.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ShowAllServicesWithFilter200ResponseDataDataInner> mapFromJson(dynamic json) {
    final map = <String, ShowAllServicesWithFilter200ResponseDataDataInner>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ShowAllServicesWithFilter200ResponseDataDataInner.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ShowAllServicesWithFilter200ResponseDataDataInner-objects as value to a dart map
  static Map<String, List<ShowAllServicesWithFilter200ResponseDataDataInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ShowAllServicesWithFilter200ResponseDataDataInner>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ShowAllServicesWithFilter200ResponseDataDataInner.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
