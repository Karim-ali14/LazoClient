...
class ClientNotification {
  /// Returns a new [ClientNotification] instance.
  ClientNotification({
    this.createdAt,
    this.id,
    this.image,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ClientNotification &&
  ...
  /// Returns a new [ClientNotification] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ClientNotification? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ClientNotification[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ClientNotification[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ClientNotification(
        ...
        isRead: num.parse('${json[r'is_read']}'),
        orderId: num.parse('${json[r'order_id']}'),
  ...
  static List<ClientNotification> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ClientNotification>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ClientNotification.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ClientNotification> mapFromJson(dynamic json) {
    final map = <String, ClientNotification>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ClientNotification.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ClientNotification-objects as value to a dart map
  static Map<String, List<ClientNotification>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ClientNotification>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ClientNotification.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
