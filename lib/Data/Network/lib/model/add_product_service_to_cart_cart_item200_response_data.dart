...
class AddProductServiceToCartCartItem200ResponseData {
  ...
  @override
  String toString() => 'AddProductServiceToCartCartItem200ResponseData[cartItems=$cartItems, createdAt=$createdAt, id=$id, productId=$productId, serviceId=$serviceId, categoriesIds=$categoriesIds, total=$total, type=$type, updatedAt=$updatedAt, userId=$userId, sessionId=$sessionId, shipmentType=$shipmentType, expectedProcessingTime=$expectedProcessingTime]';
