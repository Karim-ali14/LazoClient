...
class ShowNotifications1200ResponseDataInnerProvider {
  /// Returns a new [ShowNotifications1200ResponseDataInnerProvider] instance.
  ShowNotifications1200ResponseDataInnerProvider({
    this.accountType,
  ...
  Object? commercialRegisterImage;

  Object? commercialRegisterImagePath;
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  String? selfEmploymentDocumentPath;
  ...
  int get hashCode =>
    ...
    (ibanImagePath == null ? 0 : ibanImagePath!.hashCode) +
  ...
  @override
  String toString() => 'ShowNotifications1200ResponseDataInnerProvider[accountType=$accountType, bankAccountNumber=$bankAccountNumber, bankName=$bankName, beneficiaryName=$beneficiaryName, businessType=$businessType, cityId=$cityId, commercialRegisterImage=$commercialRegisterImage, commercialRegisterImagePath=$commercialRegisterImagePath, createdAt=$createdAt, deviceType=$deviceType, email=$email, endTime=$endTime, fcmToken=$fcmToken, hasOfflineStores=$hasOfflineStores, iban=$iban, ibanImage=$ibanImage, ibanImagePath=$ibanImagePath, id=$id, image=$image, imagePath=$imagePath, instagramLink=$instagramLink, isEmailVerified=$isEmailVerified, isPhoneVerified=$isPhoneVerified, lang=$lang, name=$name, nameAr=$nameAr, nameEn=$nameEn, offlineStoresNumber=$offlineStoresNumber, overallRating=$overallRating, ownerName=$ownerName, phone=$phone, provideDelivery=$provideDelivery, ratingsCount=$ratingsCount, selfEmploymentDocument=$selfEmploymentDocument, selfEmploymentDocumentPath=$selfEmploymentDocumentPath, snapchatLink=$snapchatLink, startTime=$startTime, status=$status, tiktokLink=$tiktokLink, updatedAt=$updatedAt, workingDaysIndices=$workingDaysIndices, workingDaysIndicesList=$workingDaysIndicesList, xLink=$xLink]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.commercialRegisterImagePath != null) {
      json[r'commercial_register_image_path'] = this.commercialRegisterImagePath;
    } else {
    ...
    if (this.ibanImagePath != null) {
      json[r'iban_image_path'] = this.ibanImagePath;
    } else {
      json[r'iban_image_path'] = null;
    }
    if (this.id != null) {
      json[r'id'] = this.id;
    } else {
    ...
    if (this.selfEmploymentDocumentPath != null) {
      ...
      json[r'self_employment_document_path'] = null;
    }
    ...
    if (this.workingDaysIndices != null) {
  ...
  /// Returns a new [ShowNotifications1200ResponseDataInnerProvider] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ShowNotifications1200ResponseDataInnerProvider? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ShowNotifications1200ResponseDataInnerProvider[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ShowNotifications1200ResponseDataInnerProvider[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ShowNotifications1200ResponseDataInnerProvider(
        ...
        hasOfflineStores: num.parse('${json[r'has_offline_stores']}'),
        ...
        offlineStoresNumber: num.parse('${json[r'offline_stores_number']}'),
  ...
  static List<ShowNotifications1200ResponseDataInnerProvider> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ShowNotifications1200ResponseDataInnerProvider>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ShowNotifications1200ResponseDataInnerProvider.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ShowNotifications1200ResponseDataInnerProvider> mapFromJson(dynamic json) {
    final map = <String, ShowNotifications1200ResponseDataInnerProvider>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ShowNotifications1200ResponseDataInnerProvider.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ShowNotifications1200ResponseDataInnerProvider-objects as value to a dart map
  static Map<String, List<ShowNotifications1200ResponseDataInnerProvider>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ShowNotifications1200ResponseDataInnerProvider>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ShowNotifications1200ResponseDataInnerProvider.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
