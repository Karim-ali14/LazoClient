...
class ManageOrders1200ResponseData {
  /// Returns a new [ManageOrders1200ResponseData] instance.
  ManageOrders1200ResponseData({
  ...
  List<ManageOrders1200ResponseDataOrderItemsInner> orderItems;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ManageOrders1200ResponseData &&
  ...
  /// Returns a new [ManageOrders1200ResponseData] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ManageOrders1200ResponseData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ManageOrders1200ResponseData[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ManageOrders1200ResponseData[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ManageOrders1200ResponseData(
        ...
        orderItems: ManageOrders1200ResponseDataOrderItemsInner.listFromJson(json[r'order_items']),
  ...
  static List<ManageOrders1200ResponseData> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ManageOrders1200ResponseData>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ManageOrders1200ResponseData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ManageOrders1200ResponseData> mapFromJson(dynamic json) {
    final map = <String, ManageOrders1200ResponseData>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ManageOrders1200ResponseData.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ManageOrders1200ResponseData-objects as value to a dart map
  static Map<String, List<ManageOrders1200ResponseData>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ManageOrders1200ResponseData>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ManageOrders1200ResponseData.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
