...
class Country {
  ...
  @override
  String toString() => 'Country[id=$id, nameEn=$nameEn, nameAr=$nameAr, createdAt=$createdAt, updatedAt=$updatedAt, name=$name, flag=$flag]';
  ...
  static Country? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Country(
        ...
        flag: mapValueOfType<String>(json, r'flag'),
      );
    }
    return null;
  }
