...
class ShowOrderDetails2200ResponseData {
  /// Returns a new [ShowOrderDetails2200ResponseData] instance.
  ShowOrderDetails2200ResponseData({
  ...
  List<ShowOrderDetails2200ResponseDataOrderItemsInner> orderItems;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ShowOrderDetails2200ResponseData &&
  ...
  /// Returns a new [ShowOrderDetails2200ResponseData] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ShowOrderDetails2200ResponseData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ShowOrderDetails2200ResponseData[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ShowOrderDetails2200ResponseData[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ShowOrderDetails2200ResponseData(
  ...
  static List<ShowOrderDetails2200ResponseData> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ShowOrderDetails2200ResponseData>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ShowOrderDetails2200ResponseData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ShowOrderDetails2200ResponseData> mapFromJson(dynamic json) {
    final map = <String, ShowOrderDetails2200ResponseData>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ShowOrderDetails2200ResponseData.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ShowOrderDetails2200ResponseData-objects as value to a dart map
  static Map<String, List<ShowOrderDetails2200ResponseData>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ShowOrderDetails2200ResponseData>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ShowOrderDetails2200ResponseData.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
