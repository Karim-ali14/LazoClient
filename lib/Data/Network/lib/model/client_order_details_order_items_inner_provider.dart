...
class ClientOrderDetailsOrderItemsInnerProvider {
  /// Returns a new [ClientOrderDetailsOrderItemsInnerProvider] instance.
  ClientOrderDetailsOrderItemsInnerProvider({
    this.id,
    this.nameEn,
    this.nameAr,
    this.ownerName,
  ...
  /// Returns a new [ClientOrderDetailsOrderItemsInnerProvider] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ClientOrderDetailsOrderItemsInnerProvider? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ClientOrderDetailsOrderItemsInnerProvider[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ClientOrderDetailsOrderItemsInnerProvider[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ClientOrderDetailsOrderItemsInnerProvider(
  ...
  static List<ClientOrderDetailsOrderItemsInnerProvider> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ClientOrderDetailsOrderItemsInnerProvider>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ClientOrderDetailsOrderItemsInnerProvider.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ClientOrderDetailsOrderItemsInnerProvider> mapFromJson(dynamic json) {
    final map = <String, ClientOrderDetailsOrderItemsInnerProvider>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ClientOrderDetailsOrderItemsInnerProvider.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ClientOrderDetailsOrderItemsInnerProvider-objects as value to a dart map
  static Map<String, List<ClientOrderDetailsOrderItemsInnerProvider>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ClientOrderDetailsOrderItemsInnerProvider>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ClientOrderDetailsOrderItemsInnerProvider.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
