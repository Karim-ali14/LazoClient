...
class ShowHome200ResponseDataTopRatedServicesInner {
  /// Returns a new [ShowHome200ResponseDataTopRatedServicesInner] instance.
  ShowHome200ResponseDataTopRatedServicesInner({
    this.cardExpiration,
    this.cardPrice,
    this.cardType,
    this.coverImagePath,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ShowHome200ResponseDataTopRatedServicesInner &&
  ...
  @override
  String toString() => 'ShowHome200ResponseDataTopRatedServicesInner[cardExpiration=$cardExpiration, cardPrice=$cardPrice, cardType=$cardType, coverImagePath=$coverImagePath, coverImage=$coverImage, createdAt=$createdAt, description=$description, descriptionAr=$descriptionAr, descriptionEn=$descriptionEn, duration=$duration, id=$id, inCart=$inCart, inWishlist=$inWishlist, isServiceDeliverableOutsideStore=$isServiceDeliverableOutsideStore, isVisible=$isVisible, name=$name, nameAr=$nameAr, nameEn=$nameEn, overallRating=$overallRating, price=$price, priceAfterDiscount=$priceAfterDiscount, providerId=$providerId, ratingsCount=$ratingsCount, updatedAt=$updatedAt]';
  ...
  /// Returns a new [ShowHome200ResponseDataTopRatedServicesInner] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ShowHome200ResponseDataTopRatedServicesInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ShowHome200ResponseDataTopRatedServicesInner[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ShowHome200ResponseDataTopRatedServicesInner[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ShowHome200ResponseDataTopRatedServicesInner(
  ...
  static List<ShowHome200ResponseDataTopRatedServicesInner> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ShowHome200ResponseDataTopRatedServicesInner>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ShowHome200ResponseDataTopRatedServicesInner.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ShowHome200ResponseDataTopRatedServicesInner> mapFromJson(dynamic json) {
    final map = <String, ShowHome200ResponseDataTopRatedServicesInner>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ShowHome200ResponseDataTopRatedServicesInner.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ShowHome200ResponseDataTopRatedServicesInner-objects as value to a dart map
  static Map<String, List<ShowHome200ResponseDataTopRatedServicesInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ShowHome200ResponseDataTopRatedServicesInner>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ShowHome200ResponseDataTopRatedServicesInner.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
