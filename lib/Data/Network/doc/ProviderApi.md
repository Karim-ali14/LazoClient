...
[**showtransactions**](ProviderApi.md#showtransactions) | **GET** /provider/transactions | show transactions
...
try {
    ...
    print('Exception when calling ProviderApi->showtransactions: $e\n');
}
```
