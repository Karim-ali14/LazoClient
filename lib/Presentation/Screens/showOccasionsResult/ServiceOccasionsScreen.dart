...
class ServiceOccasionScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ServiceOccasionScreen> createState() =>
      _ServiceOccasionScreenState();
}

class _ServiceOccasionScreenState extends ConsumerState<ServiceOccasionScreen> {
                        ...
                        itemBuilder: (context, index) {
                          return CategoryFilterItemCard(
                            ...
                            onSelectCategory: (item) {
                              ...
                              ref
                                  .read(
                                  updateOccasionServiceListOfFilterSelectedStateNotifiers
                                      .notifier)
                                  .removeItem(item);
                              updateFilterData(filterForServicesData);
                              //
  ...
  void clearFilterData() {
    ref
        .read(updateOccasionServiceListOfFilterSelectedStateNotifiers.notifier).clearAll();
  }
