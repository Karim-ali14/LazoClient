...
class ServiceGridListviewWithCategoryName extends StatefulWidget {
  ...
  final String title;
  final int? rootId;
  const ServiceGridListviewWithCategoryName({super.key, this.list, this.showLoading, required this.onAddItemToCart, required this.onAddItemToWishList, required this.onItemClick, required this.title, this.rootId});

  @override
  State<ServiceGridListviewWithCategoryName> createState() => _ServiceGridListviewWithCategoryNameState();
}

class _ServiceGridListviewWithCategoryNameState extends State<ServiceGridListviewWithCategoryName> {
  @override
